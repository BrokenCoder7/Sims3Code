...
namespace Echoweaver.Sims3Game.WarriorCats
{
    ...
    public class Loader //ADDED : GameObject BECAUSE PUDDINGFACE TUTORIAL
    {
        ...
        //ADDED THE THREE BELOW FROM THE Config CLASS AFTER REMOVAL
